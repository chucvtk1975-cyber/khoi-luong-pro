...
- **Cập nhật phiên bản Cache-Buster khi sửa CSS/JS**: Mỗi khi chỉnh sửa file `style.css` hoặc `app.js`, bắt buộc phải tăng hoặc cập nhật tham số phiên bản (Query Parameter `?v=...`) tương ứng của file đó trong thẻ liên kết tại [index.html](file:///d:/Kho%20tri%20th%E1%BB%A9c/khoi-luong-pro/index.html) để ép trình duyệt người dùng xóa cache và tải phiên bản mới nhất.
