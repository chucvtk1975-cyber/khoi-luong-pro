...
import { DB, onDbSave, setCloudSync, migratePhotosToIndexedDB } from './src/db.js?v=20260805-v1';
import { triggerAutoSync } from './src/excel.js?v=20260805-v1';
import { initTakeoffUI } from './src/takeoff.js?v=20260805-v1';
import { CloudSync } from './src/cloud-sync.js?v=20260805-v1';
